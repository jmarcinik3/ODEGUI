...
class TimeEvolutionTab(Tab):
    ...
    def addVariableRows(self, names: Union[str, List[str]]) -> Union[TimeEvolutionVariableRow, List[TimeEvolutionVariableRow]]:
        """
        ...
        if isinstance(names, str):
            ...
            return new_row
        elif isinstance(names, list): return [self.addVariableRows(name) for name in names]
    ...
    def getInitialConditions(self, names: str = None) -> Union[float, Dict[str, float]]:
        ...
        elif isinstance(names, list): return {name: self.getInitialConditions(names=name) for name in names}
        elif names is None: return self.initial_conditions
    def getTimeEvolutionTypes(self, name: str, index: int = None) -> Union[str, List[str]]:
        ...
        elif index is None: return self.time_evolution_types[name]
...
class ParameterRow(TabRow):
    ...
    """
    def __init__(self, name: str, section: ParameterSection, parameter_types: Tuple[str] = ("Constant", "Free")) -> None:
        """
    ...
    def getParameterTypes(self, index: int = None) -> Tuple[str]:
        ...
        elif index is None: return self.parameter_types
        else: raise TypeError("index must be int")
...
class ParameterSection(Element):
    ...
    def addParameterRows(self, names: Union[str, List[str]]) -> Union[ParameterRow, List[ParameterRow]]:
        ...
        if isinstance(names, str):
            ...
            return new_row
        elif isinstance(names, list): return [self.addParameterRows(name) for name in names]
        else: raise RecursiveTypeError(names)
...
class FunctionRow(TabRow):
    ...
    def getFormLabel(self) -> Union[sg.Text, sg.Image]:
        ...
        for filename_temp in ["equations/hb_eqs.yml", "equations/soma_eqs.yml", "equations/hb-soma_eqs.yml"]:
            ...
            try: form = function_info[self.getName()]["form"]
            except KeyError:
                try: form = function_info[self.getName()]["pieces"]
...
class FunctionTab(Tab):
    ...
    def addFunctionRows(self, names: Union[str, List[str]]) -> Union[FunctionRow, List[FunctionRow]]:
        ...
        if isinstance(names, str):
            ...
            return new_row
        elif isinstance(names, list): return [self.addFunctionRows(name) for name in names]
        else: raise RecursiveTypeError(names)
...
class MainWindow(TabbedWindow):
    ...
    def __init__(self, name: str, runner: MainWindowRunner, blueprint: dict) -> None:
        ...
        dimensions = {
            ...
            "evolution_type_text": YML.getDimensions(["main_window", "time_evolution_tab", "header_row", "evolution_type_text"]),
            "variable_text": YML.getDimensions(["main_window", "time_evolution_tab", "header_row", "variable_text"]),
            "initial_condition_text": YML.getDimensions(["main_window", "time_evolution_tab", "header_row", "initial_condition_text"]),
            "evolution_type_combobox": YML.getDimensions(["main_window", "time_evolution_tab", "variable_row", "evolution_type_combobox"]),
            "variable_label": YML.getDimensions(["main_window", "time_evolution_tab", "variable_row", "variable_label"]),
            "initial_condition_input_field": YML.getDimensions(["main_window", "time_evolution_tab", "variable_row", "initial_condition_input_field"]),
            "initial_equilibrium_checkbox": YML.getDimensions(["main_window", "time_evolution_tab", "variable_row", "initial_equilibrium_checkbox"]),
            ...
            "parameter_header_label": YML.getDimensions(["main_window", "parameter_tab", "header_row", "section_label"]),
            "parameter_label": YML.getDimensions(["main_window", "parameter_tab", "parameter_row", "parameter_label"]),
            "parameter_value_label": YML.getDimensions(["main_window", "parameter_tab", "parameter_row", "parameter_value_label"]),
            "parameter_value_input_field": YML.getDimensions(["main_window", "parameter_tab", "parameter_row", "parameter_value_input_field"]),
            "parameter_type_combobox": YML.getDimensions(["main_window", "parameter_tab", "parameter_row", "parameter_type_combobox"]),
            ...
            "function_header_row_function_label": YML.getDimensions(["main_window", "function_tab", "header_row", "function_label"]),
            "function_header_row_form_label": YML.getDimensions(["main_window", "function_tab", "header_row", "form_label"])
        }
    ...
    def addVariableNames(self, names: Union[str, List[str]]) -> Union[str, List[str]]:
        ...
        elif isinstance(names, list): return [self.addVariableNames(names=name) for name in names]
        else: raise RecursiveTypeError(names)
    ...
    def addFunctionNames(self, names: Union[str, List[str]]) -> Union[str, List[str]]:
        ...
        elif isinstance(names, list): return [self.addFunctionNames(names=name) for name in names]
        else: raise RecursiveTypeError(names)
    ...
    def getBlueprints(self, tab_name: str = None) -> dict:
        ...
        """
        if tab_name is None: return self.blueprint
        else: return self.blueprint[tab_name]
        ...
        menu_definition = [
            ...
            ["Set",
                ...
                "Time-Evolution Types to...",
                    ["Temporal::set_time_evolution_types_to", "Equilibrium::set_time_evolution_types_to", "Constant::set_time_evolution_types_to", "Function::set_time_evolution_types_to"]
                ]
            ]
        ]
        kwargs = {
...
class MainWindowRunner(WindowRunner):
    ...
    def runWindow(self) -> None:
        ...
        while True:
            ...
            if menu_value is not None:
                if event == "Parameters::import": self.loadParametersFromFile()
            ...
            elif event == "Update Parameters": self.updateParameters()
            elif event == self.getKey("open_simulation"): self.openSimulationWindow()
        window.close()
    ...
    def getInitialConditions(self, names: Union[str, List[str]] = None) -> Union[float, ndarray, str]:
        ...
        if isinstance(names, str):
            ...
            is_initial_equilibrium = self.getValue(self.getKey("initial_condition_equilibrium", names)) or is_equilibrium
            
            if is_initial_equilibrium: return "Equilibrium"
            else:
                input_field_key = self.getKey("initial_condition_value", names)
                try: value = float(self.getValue(input_field_key))
                except AttributeError: value = float(YML.getStates("initial_condition", names))
                return value
        elif isinstance(names, list): return array(self.getInitialConditions(names=name) for name in names)
        else: raise RecursiveTypeError(names)
    def getTimeEvolutionTypes(self, names: Union[str, List[str]] = None) -> Union[str, List[str]]:
        ...
        if isinstance(names, str):
            ...
            try: return self.getValue(key)
            except AttributeError: return YML.getStates("time_evolution_types", names)
        elif isinstance(names, list): return [self.getTimeEvolutionTypes(names=name) for name in names]
        else: raise RecursiveTypeError(names)
    ...
    def getFunctionYMLs(self) -> List[str]:
        ...
        if isinstance(function_ymls, str): return [function_ymls]
        elif isinstance(function_ymls, list): return function_ymls
        else: raise TypeError("function_ymls must be of type str or list")
    def getParameters(self, names: Union[str, List[str]] = None,
        ...
        if isinstance(names, str):
            ...
            if names in parameters.keys():
                ...
                if "quantity" in form: return quantity
                elif "value" in form: return quantity.magnitude
                elif "unit" in form: return quantity.units
                raise ValueError("Invalid entry for form input")
            else: return None
        elif isinstance(names, list): return {name: self.getParameters(names=name, form=form) for name in names}
        elif names is None: return self.getParameters(names=self.getParameterNames(), form=form)
        else: raise RecursiveTypeError(names)
    def setParameters(self, name: str, quantity: Quantity) -> None:
        ...
        elif old_quantity is None: pass
        else: raise TypeError("new quantity must be same class as old quantity")
    ...
    def getParameterFields(self, names: Union[str, List[str]] = None) -> Union[str, List[str]]:
        ...
        if isinstance(names, str):
            ...
            return field_value
        elif isinstance(names, list): return [self.getParameterFields(names=name) for name in names]
        elif names is None: return self.getParameterFields(names=self.getParameterNames())
        else: raise RecursiveTypeError(names)
    def updateParameters(self, names: Union[str, List[str]] = None) -> None:
        ...
        elif names is None: self.updateParameters(names=self.getParameterNames())
        else: raise TypeError("names input be str or list")
    def updateParameterLabels(self, names: Union[str, List[str]] = None) -> None:
        ...
        elif names is None: self.updateParameterLabels(names=self.getParameterFields())
        else: raise RecursiveTypeError(names)
    ...
    def loadParametersFromFile(self, filenames: str = None, choose_parameters: bool = True) -> None:
        ...
        if filenames is None:
            ...
            if filenames is None: return None
            elif filenames is not None: filenames = filenames.split(';')
        ...
        else: parameter_names = self.getParameterNames()
